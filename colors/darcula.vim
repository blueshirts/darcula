...
hi Cursor ctermfg=188 ctermbg=250 cterm=NONE guifg=#2b2b2b guibg=#aababa gui=NONE
...
hi Search term=reverse ctermfg=188 ctermbg=24 guifg=#aababa guibg=#214283 gui=none
hi IncSearch term=reverse ctermfg=188 ctermbg=24 guifg=#404245 guibg=#b1c73d gui=none
hi Directory ctermfg=103 ctermbg=NONE cterm=NONE guifg=#67609c guibg=NONE gui=italic
hi Folded ctermfg=244 ctermbg=235 cterm=NONE guifg=#8e9292 guibg=#2b2b2b gui=NONE

hi Normal ctermfg=188 ctermbg=235 cterm=NONE guifg=#aababa guibg=#2b2b2b gui=NONE
hi Boolean ctermfg=103 ctermbg=NONE cterm=NONE guifg=#c57825 guibg=NONE gui=bold
hi Character ctermfg=103 ctermbg=NONE cterm=NONE guifg=#67609c guibg=NONE gui=italic
...
hi Constant ctermfg=103 ctermbg=NONE cterm=NONE guifg=#67609c guibg=NONE gui=bold
hi Define ctermfg=172 ctermbg=NONE cterm=NONE guifg=#c57825 guibg=NONE gui=bold
hi DiffAdd ctermfg=188 ctermbg=64 cterm=bold guifg=#aababa guibg=#365546 gui=bold
hi DiffDelete ctermfg=88 ctermbg=NONE cterm=NONE guifg=#8c0909 guibg=NONE gui=NONE
hi DiffChange ctermfg=188 ctermbg=23 cterm=NONE guifg=#aababa guibg=#263b59 gui=NONE
hi DiffText ctermfg=188 ctermbg=24 cterm=bold guifg=#aababa guibg=#204a87 gui=bold
...
hi Label ctermfg=103 ctermbg=NONE cterm=NONE guifg=#67609c guibg=NONE gui=NONE
hi NonText ctermfg=188 ctermbg=235 cterm=NONE guifg=#aababa guibg=#2b2b2b gui=NONE
hi Number ctermfg=67 ctermbg=NONE cterm=NONE guifg=#7ca8c6 guibg=NONE gui=NONE
hi Operator ctermfg=250 ctermbg=NONE cterm=NONE guifg=#aababa guibg=NONE gui=NONE
...
hi String ctermfg=71 ctermbg=NONE cterm=NONE guifg=#60754e guibg=NONE gui=NONE
hi Tag ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi Title ctermfg=159 ctermbg=NONE cterm=bold guifg=#aababa guibg=NONE gui=bold
...
hi rubyStringDelimiter ctermfg=71 ctermbg=NONE cterm=NONE guifg=#60754e guibg=NONE gui=NONE
...
hi rubyRegexp ctermfg=71 ctermbg=NONE cterm=NONE guifg=#60754e guibg=NONE gui=NONE
hi rubyRegexpDelimiter ctermfg=71 ctermbg=NONE cterm=NONE guifg=#60754e guibg=NONE gui=NONE
...
hi htmlTag ctermfg=222 ctermbg=NONE cterm=NONE guifg=#c57825 guibg=NONE gui=NONE
hi htmlEndTag ctermfg=222 ctermbg=NONE cterm=NONE guifg=#c57825 guibg=NONE gui=NONE
hi htmlTagName ctermfg=222 ctermbg=NONE cterm=NONE guifg=#c57825 guibg=NONE gui=NONE
hi htmlArg ctermfg=222 ctermbg=NONE cterm=NONE guifg=#aababa guibg=NONE gui=NONE
...
hi cssColor ctermfg=103 ctermbg=NONE cterm=NONE guifg=#67609c guibg=NONE gui=italic
...
hi jadeClass ctermfg=103 ctermbg=NONE cterm=NONE guifg=#67609ckeyword guibg=NONE gui=italic
